...
*/
        ...
        #include "map_files\Infinity_cyberiad\cyberiad.dmm"
        #include "map_files\Infinity_cyberiad\z2.dmm"
        #include "map_files\Infinity_cyberiad\z3.dmm"
        #include "map_files\Infinity_cyberiad\z4.dmm"
        #include "map_files\Infinity_cyberiad\z5.dmm"
        #include "map_files\Infinity_cyberiad\z6.dmm"
        #include "map_files\Infinity_cyberiad\z7.dmm"

        #define MAP_FILE "cyberiad.dmm"
        #define MAP_NAME "NSS Infinity Cyberiad"
...
DECLARE_LEVEL(EMPTY_AREA, CROSSLINKED, list(REACHABLE)))
	...
	#warn a map has already been included, ignoring Infinity Cyberiad.
